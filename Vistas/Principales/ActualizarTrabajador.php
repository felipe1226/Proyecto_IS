                            ...
                            $cantidad = pg_num_rows($consulta);
                                if($cantidad>0){
			 							 ...
			 							 echo '<div class="signup-form"><!--sign up form-->
			 							 	<form id ="registrarTrabajador" method="POST" action="/Proyecto_IS/Controladores/Trabajadores/cActualizar.php">
												<table class="table table-condensed">
													...
													<tbody>
													<tr>
														<td>Identificación:</td><td><input   name="iden"  id = "iden" type="text" value="'.$info[0].'" />
							                         </tr>
							                         <tr>
														<td>Nombre:</td><td><input name="nombre"  id = "nombre" type="text" value="'.$info[1].'" />
							                         </tr>
														<td>Apellido:</td><td><input name="apellido"  id = "apellido" type="text" value="'.$info[2].'"/></td>
													</tr>
													 <tr>
														<td>Telefono:</td><td><input name="telefono"  id = "telefono" type="text" value="'.$info[3].'"/>
							                         </tr>
													<tr>
														<td>Salario :</td>
													  <td><input name="salario"  id ="salario" type="text"  value="'.$info[5].'"/></td>
													</tr>
													<tr>
												...
												<form name="eliminarTrabajador" id="eliminarTrabajador" method="POST" action="../../Controladores/Trabajadores/cEliminar.php">
													<input name="identificacion" id = "identificacion" type="text" value="'.$info[0].'"/>
									...
									echo '<td class="cart_description" align="center">
										...
										<p align="center">¡El trabajador con identificacion '.$_POST['consulta'].' no se encuentra registrado!</p>
										</td>';
								}
				        }
