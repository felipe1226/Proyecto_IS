...
<head>
    ...
    <title>Listar de Responsable por Proyectos | Fundacion Pro Niñez</title>
		...
		<div class="container">
			<div class="table-responsive cart_info">
				...
				<table class="table table-condensed">
					<thead>
						<tr class=cart_menu><td class="image" colspan="11"><center><p2>LISTA DE RESPONSABLE POR DETERMINADO PROYECTO</p2></center></td>
						</tr>
						<tr class="cart_menu">
					...
					<tbody>
						...
						<?php 
							if($consulta = $proyecto->responsablexproyecto()){
