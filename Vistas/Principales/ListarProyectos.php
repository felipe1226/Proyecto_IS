	...
	<section id="cart_items">
		<div class="container">
			...
			if($consulta = $proyecto->listar_proyecto()){
				...
				if($cantidad>0){
					if(($_POST['tbusqueda']=="todo") || ($_POST['opcion']=="Comunidad")){
						...
						echo '<table class="table table-condensed">
							...
							<tbody>';
							if(($_POST['opcion']=="Responsable") || ($_POST['opcion']=="Fecha")){
								echo '<table class="table table-condensed">
									<thead>
										<tr class=cart_menu><td class="image" colspan="11"><center><p2>LISTA DE PROYECTOS</p2></center></td>
										</tr>
				...
				echo "<td class='cart_description' align='center'>
						<p align='center'>¡No hay proyectos registrados en la base de datos!</p>
					  </td>";
			}
			?>
			</div>
