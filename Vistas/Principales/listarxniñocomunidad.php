...
<head>
    ...
    <title>Listar Infate por comunidad | Fundacion Pro Niñez</title>
		...
		<div class="container">
			<div class="table-responsive cart_info">
				...
				<table class="table table-condensed">
					<thead>
						<tr class=cart_menu><td class="image" colspan="11"><center><p2>LISTA DE INFANTE POR COMUNIDAD</p2></center></td>
						</tr>
						<tr class="cart_menu">
							...
							<td class="description">CODIGO DE LA COMUNIDAD</td>
					...
					<tbody>
						...
						<?php 
							if($consulta = $proyecto->listarxniñocomunidad()){
